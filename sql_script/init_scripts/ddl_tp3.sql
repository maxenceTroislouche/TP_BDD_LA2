...
CREATE PROCEDURE Delete_Temp_Tables_CM_IMMO()
BEGIN
    DROP TABLE IF EXISTS CM_IMMO.TEMP_AUTHS;
    DROP TABLE IF EXISTS CM_IMMO.TEMP_COMMENTS;
    DROP TABLE IF EXISTS CM_IMMO.TEMP_LOCATIONS;
    DROP TABLE IF EXISTS CM_IMMO.TEMP_QUESTIONS;
    DROP TABLE IF EXISTS CM_IMMO.TEMP_REPONSES;
    DROP TABLE IF EXISTS CM_IMMO.TEMP_TIERS;
END $$
...
BEGIN
    ...
    CALL Delete_Temp_Tables_CM_IMMO();
    CALL Create_CM_IMMO_DB();
END $$
