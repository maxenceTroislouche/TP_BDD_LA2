...
LOAD DATA INFILE '/var/lib/mysql-files/answers.csv' INTO TABLE TEMP_REPONSES FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 ROWS (idQuestion, texte, datePublication);
LOAD DATA INFILE '/var/lib/mysql-files/comments.csv' INTO TABLE TEMP_COMMENTS FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 ROWS (id, idCommentaireOriginal, texte, type);
